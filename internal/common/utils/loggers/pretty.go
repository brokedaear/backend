...
// SPDX-FileCopyrightText: 2023 Dusted Codes Limited <go@dusted.codes>
//
// SPDX-License-Identifier: Apache-2.0

// Retrieved from: https://dusted.codes/creating-a-pretty-console-logger-using-gos-slog-package
// Also see: https://github.com/golang/example/tree/master/slog-handler-guide
package loggers
